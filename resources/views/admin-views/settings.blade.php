                ...
                <!-- Card -->
                    <div class="card mb-3" id="generalDiv">
                        ...
                        <div class="profile-cover">
                            <div class="profile-cover-img-wrapper justify-content-between">
                            @php($banner_logo = \App\Models\Banner::where(['image' => '2024-05-01-663205451ffb4.png'])->first()?->value)
                            <a class="navbar-brand d-block p-0" href="{{ route('admin.dashboard') }}" aria-label="Front">
                                    ...
                                    src="{{\App\CentralLogics\Helpers::onerror_image_helper($banner_logo, dynamicStorage('storage/app/public/banner/'.$banner_logo), dynamicAsset('public/assets/admin/img/160x160/img2.jpg'), 'banner/') }}"
                                    alt="image">
