...
function route_alert(
    ...
    if (processing) {
        Swal.fire({
            title: title,
            icon: "warning", // Use 'icon' instead of 'type' (deprecated in SweetAlert2)
            showCancelButton: true,
            cancelButtonColor: "default",
            confirmButtonColor: "#FC6A57",
            cancelButtonText: "Cancel", // Translate this on the server side if needed
            confirmButtonText: "Submit", // Translate this on the server side if needed
            inputPlaceholder: "Enter processing time",
            input: "text",
            html:
                message +
                "<br/>" +
                "<label>Enter Processing time in minutes</label>",
        ...
        Swal.fire({
            ...
            cancelButtonColor: "default",
            confirmButtonColor: "#FC6A57",
            cancelButtonText: "No", // Translate this on the server side if needed
            confirmButtonText: "Yes", // Translate this on the server side if needed
            reverseButtons: true,
        }).then((result) => {
            if (result.value) {
                location.href = route;
